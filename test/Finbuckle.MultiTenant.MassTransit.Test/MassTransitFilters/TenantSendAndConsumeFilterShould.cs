...
namespace Finbuckle.MultiTenant.MassTransit.Test.MassTransitFilters
{
    public class TenantSendAndConsumeFilterShould
    {
        ...
        public async Task SendMessageWithTenantIdentifierHeaderCreated(string? tenantIdentifier, string? expectedTenant)
        {
            // Arrange
        ...
        public async Task SendMessageWithNoTenantIdentifierHeader(string? tenantIdentifier, string? expectedTenant)
        {
            // Arrange
            MultiTenantMassTransitTestSetup? setup = new MultiTenantMassTransitTestSetup().Setup();
            await setup.StartHarnessAsync();
