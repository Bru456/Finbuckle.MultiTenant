...
namespace Finbuckle.MultiTenant.MassTransit.Test.MassTransitFilters
{
    public class TenantPublishAndConsumeFilterShould
    {
        ...
        public async Task PublishMessageWithTenantIdentifierHeaderCreated(string? tenantIdentifier, string? expectedTenant)
        {
            // Arrange
            MultiTenantMassTransitTestSetup? setup = new MultiTenantMassTransitTestSetup().Setup();
        ...
        public async Task PublishMessageWithNoTenantIdentifierHeader(string? tenantIdentifier, string? expectedTenant)
        {
            // Arrange
            MultiTenantMassTransitTestSetup? setup = new MultiTenantMassTransitTestSetup().Setup();
            await setup.StartHarnessAsync();
