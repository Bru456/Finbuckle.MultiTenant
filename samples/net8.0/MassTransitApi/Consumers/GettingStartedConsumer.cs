...
using MassTransitApi.Contracts;
...
namespace MassTransitApi.Consumers
{
    public class GettingStartedConsumer : IConsumer<HelloMessage>
    {
        ...
        {
            _logger.LogInformation("Tenant: {Tenant} Received: {Text}", _mtca.MultiTenantContext.TenantInfo.Identifier, context.Message.Text);
